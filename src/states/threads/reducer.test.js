...
describe("threadReducers function", () => {
  ...
  it("should return the threads with the neutralvoted threads when given by NEUTRAL_VOTE_THREAD action", () => {
    ...
    const nextStateNeutralUpVotes = threadsReducer(initialState, actionNeutralUpVotes)
    ...
    const nextStateNeutralDownVotes = threadsReducer(initialState, actionNeutralDownVotes)
